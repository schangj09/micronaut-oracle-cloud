...
/**
 * Test with mock list of secrets to validate that the vault bootstrap config client loods
 * all of the secrets from the Vault.
 *
 * @author schangj09
 */
...
class OracleCloudVaultConfigurationClientSpecAll extends Specification {
    ...
    void "it loads all secrets from the vault"() {
        given:
